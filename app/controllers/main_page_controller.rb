...
@@logger = Logger.new(STDOUT)
 ...
 "debugClass.js",
 "default.js",
 "delegateListClass.js",
 "helperClass.js",
 "hoverDataConnectorClass.js",
 "mainViewClass.js",
 "main_page.coffee",
 "panelClass.js",
 "scrollClass.js",
      ...
      def walkTreeView(directory, level, nodeList)
        ...
        listDirectoyBaseUrl = '/main_page/listCategory'
         listDirectoyParamSet = {:instanceObj             => 'args.mv', 
             ...
             Dir.foreach(directory) {|x|
                if x == '.' or  x == '..' or x == 'thumb' or  x == 'display' or  x == 'yui' or x == "wallpapers" or ["assets","404.html","422.html","500.html","favicon.ico","robots.txt", "animated.ajax.loader.gif",
 "base_sand_bg_opacity_dot70.png",
 "check",
 "container_tl.png",
 "container_tm.png",
